...
function createCryptoSentimentTable(containerId) {
  ...
  const TOP_40_COINS = {
    ...
    IMX: base_link + 'immunefi',
    RNDR: base_link + 'render-token',
    VET: base_link + 'vechain',
    MKR: base_link + 'maker',
    GRT: base_link + 'the-graph',
    OP: base_link + 'optimism',
    INJ: base_link + 'injective-protocol',
  };
